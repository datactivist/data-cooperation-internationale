...
subtitle: ""
author: "Clément Mandron, Cécile le Guen"
date: "2024"
output:
...
1. Prénom
2. Quel est votre rapport à la donnée (étude, stage, ...) ?
...
* Découvrir des cas d'usage de l'utilisation des données dans les politiques de coopération international
* Comprendre la place de la donnée et de la quantification dans les programmes de développement
* Découvrir la gouvernance des données autour des données de l'Aide Publique au Développement (standard international IATI, portail open data interministériel)
...
2. Focus : Comment mesurer l'efficacité de l'Aide Publique au Développement ?
...
Evaluation des politiques publiques et des programmes de développement, dématérialisation de l'administration, identification des personnes, transparence de l'action publique, améliorer les prises de décisions, etc...
...
The World Bank, through its Global Facility for Disaster Reduction and Recovery (GFDRR),
launched the Open Cities Project in November 2012 to create open data ecosystems that will
facilitate innovative, data-driven urban planning and disaster risk management in South Asian cities.

Collecter les données ouvertes à partir d'OpenStreetMap pour anticiper les risques et prendre des décisions : montée des eaux (où sont les écoles, et les hopitaux ?), diffusion des épidémies (quelle cartographie des réseaux de distribution d'eau ?), etc...
...
## 3. Gestion des risques et de crises
...
Le Centre de crise et de soutien (CDCS) accompagne les opérateurs interministériels de l’État et les organismes qui contribuent à la coopération internationale de sécurité des ressortissants. Il accompagne également les entreprises françaises déployées à l’étranger pour anticiper et prévenir les enjeux de sécurité

- Partage d'analyse sur la situation sécuritaire des pays
- L’élaboration de cartes sécuritaires
...
## 5. Défense des droits des minorités

.center[<img src="./img/lgbt.png" height="300"/>]

[Progressive cash for the anti-LGBTQI backlash?](https://centreforfeministforeignpolicy.org/2023/04/24/report-progressive-cash-for-the-anti-lgbtqi-backlash/)
...
[Contibuteurs et constributrices Wikipedia](https://fr.wikipedia.org/wiki/Donn%C3%A9es_ouvertes#cite_note-GDT-1)
...
* Conseillère de nombreux dirigeants
...
Source : https://www.college-de-france.fr/sites/default/files/documents/alain-supiot/UPL2335835739398687161_supiot.pdf page 729x
...
> _« L’annonce, dans le projet de loi de finances présenté le jeudi 10 octobre, d’une diminution drastique de 1,3 milliard d’euros de l’aide publique au développement (APD) par la France marque un coup d’arrêt incompréhensible à la progression observée pendant les sept dernières années pour atteindre l’objectif des 0,7 % du revenu national brut fixé par les Nations unies en 1970.»_

]

.pull-right[

<img src="./img/lemonde1.png" height="400"/>

[Tribune dans Le Monde](https://www.lemonde.fr/idees/article/2024/10/21/l-aide-publique-au-developpement-doit-etre-envisagee-comme-un-investissement-et-non-comme-un-cout_6357695_3232.html)
]
...
## Adopter un regarde critique : l'approche de la sociologie de la quantification

.center[<img src="./img/quantification.jpg" height="300"/>]

> [Henneguelle, A. et Jatteau, A. (2021). Sociologie de la quantification. ](https://doi.org/10.3917/dec.henne.2021.01)

???

Plus précisement, sur l'ADP 
https://shs.cairn.info/revue-tiers-monde-2013-1-page-33?lang=fr 
...
Vous effectuez un stage de fin d'étude à **l'Ambassade de France en Argentine**. Votre supérieur vous informe que le·a directeur·rice Argentine de l'AFD va changer et que la nouvelle personne en poste va rapidemment prendre contact avec l'ambassadeur. 
**Vous êtes chargé·e de réaliser une note, appuyée sur des données sur l'action de l'AFD en Amérique du Sud, dans laquelle doit figurer cette carte.**
